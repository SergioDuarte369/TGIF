...
createTableNumbersAndVotes(miembros);
...
let contenidoTablaNumbers = `
  <thead>
                  ...
                  function arrayPorcentajeMiembrosMost(array) {
                    ...
                    let orden = array.slice().sort((a,b) => a.missed_votes_pct - b.missed_votes_pct)
                  ...
                  function createTableLeast(array) {
                    let tablaLeast = document.getElementById("least_engaged")
                    contenidoTablaLeast =`
                    <thead>
                                        <tr>
                                            <th>Name</th>
                                  ...
                                  for (let index = 0; index < array.length; index++) {
                                    ...
                                    contenidoTablaLeast += `<tr> 
                                       ...
                                       <td>${array[index].missed_votes}</td>
                                       <td>${array[index].missed_votes_pct}</td>
                                       </tr>`;
                  ...
                  function createTableMost(array) {
                    let tablaMost = document.getElementById("most_engaged")
                    contenidoTablaMost =`
                    <thead>
                                        <tr>
                                            <th>Name</th>
              ...
              ///// Funciones para la página Party Loyalty
